    ...
    useMemo(() => {
      ...
      try {
        if (listWorkerFilterTypeParam && sizeClassQueueNameUrlParam) {
          decodedListWorkerFilterType = decodeURIComponent(
            listWorkerFilterTypeParam,
          ) as ListWorkerFilterType;
          decodedSizeClassQueueName = JSON.parse(
            decodeURIComponent(sizeClassQueueNameUrlParam),
          ) as SizeClassQueueName;
          if (paginationCursorUrlParam) {
            decodedPaginationCursor = JSON.parse(
              decodeURIComponent(paginationCursorUrlParam),
            ) as WorkerState["id"];
          }
        }
      } catch (error) {
